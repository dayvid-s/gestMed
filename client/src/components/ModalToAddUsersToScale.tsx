    ...
    return (
        <>
            <Modal className='z-10' backdrop={true} size="lg" open={modalIsOpen} onClose={handleClose}>
                <Modal.Header>
                    <h4 className='text-4xl'>Adicionar Médicos na Escala</h4>
                </Modal.Header>
                <Modal.Body style={{ height: "80vh" }}>
                    ...
                    <Form>
                        <div className='flex flex-col sm:flex-row flex-wrap gap-y-3.5 justify-between items-center'>
                            <Form.Group controlId="name">
                                <Form.ControlLabel>Nome do Médico</Form.ControlLabel>
                                <Form.Control name="name" value={doctorInfo.name} />
                            </Form.Group>


                            <Form.Group>
                                <Form.ControlLabel>Especialidade</Form.ControlLabel>
                    ...
                    <div title="Editar conta" className='flex flex-row flex-wrap items-center justify-start w-full gap-x-6 gap-y-4 ' >
                        ...
                        <div className='p-5 border-2 border-bg[#green500] rounded-md flex flex-row  bg-green-900' >
                        ...
                        <div className='flex flex-col cursor-pointer ' >
                            ...
                            <p className='text-xl font-extrabold text-white '>
                                ...
                                <span className='text-gray-400 ' > Cardiologista</span>
